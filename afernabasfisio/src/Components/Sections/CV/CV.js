    ...
    render() {
      return (
        <Menu Title="Curr&iacute;culum" MenuId="Curriculum"> 
          <h2>Antonio Fern&aacute;ndez-Abascal Alonso</h2>
            <ul className="CVList">
            ...
            <h2>Tamara Garc&iacute;a Lera </h2>
            <ul className="CVList">
                <li>Diplomada en Fisioterapia por la Uax - Madrid</li> 
                <li>Master con Nivel estructural, craneal, visceral en Osteopat&iacute;a, escuela ICOMED</li> 
                <li>Diplomada por la escuela de perfeccionamiento Biom&eacute;dica,en kinesiolog&iacute;a aplicada</li> 
                <li>T&eacute;cnico Superior en Diet&eacute;tica y Nutrici&oacute;n</li> 
                <li>Experto en Fisioterapia Obst&eacute;trica, terapia manual Pelviperineal y uroginecolog&iacute;ca. Impartido por el CRF Amostegui y Cpfcyl</li> 
